...
<html>
<head>
<jsp:include page="/WEB-INF/include/include-header.jspf"></jsp:include>
<title>Oneted</title>
<meta charset="UTF-8">
...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<nav class="w3-sidebar w3-collapse w3-white w3-animate-left"
		...
		<div class="w3-container">
			...
			</a> <img src="resources/images/${TEAMINFO.TEAM_IMG}" style="width: 45%;"
				alt="팀사진" class="w3-round"><br> <br>
			<h4>
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<!-- Header -->
		<header id="portfolio">
			<a href="#"><img src="resources/images/${TEAMINFO[1].TEAM_IMG}"
				alt="로고" style="width: 65px;"
			...
			<div class="w3-container">
				...
				<!-- 					</button> -->
				<!-- 					<button class="w3-button w3-white w3-hide-small"> -->
				<!-- 						<i class="fa fa-map-pin w3-margin-right"></i>Manager -->
				<!-- 					</button> -->
				<!-- 				</div> -->
			</div>
		</header>
