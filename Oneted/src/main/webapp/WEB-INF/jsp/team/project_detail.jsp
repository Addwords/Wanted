...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <c:forEach items='${projectone}' var='cd'>
  <img src="../resources/images/${cd.PIMG }" width="60" height="60">
  </c:forEach>
<!--   <img src="/w3images/avatar_smoke.jpg" style="width:100%"> -->
  <a href=<c:url value='/team/openTeamList.do'/> class="w3-bar-item w3-button w3-padding-large w3-black">
...
<div class="w3-padding-large" id="main">
  ...
  <c:forEach items="${projectone}" var="dto">
    <h1 class="w3-jumbo">${dto.PNAME }</h1>
