...
<body>
	...
	<nav
		...
		style="z-index:3;width:320px;" id="mySidebar"> <a id="OneTed"
		href="javascript:void(0);"
		class="w3-bar-item w3-button w3-border-bottom w3-large"><span
		style="font-weight: bold;"><span style="color: red">One</span>Ted</span>
		Message</a> <a href="javascript:void(0)" onclick="w3_close()"
					...
					<a href="javascript:void(0)" name="title"
						...
						<div class="w3-container" style="padding: 0px">
							...
							<div class="open" style="margin-left: 30px">
								<i class="material-icons" style="color:red">contact_mail</i>&nbsp;&nbsp;<span
									class="w3-opacity w3-large">${row.SENDER}</span>
								<h6>${row.SUBJECT}</h6>
							</div>
						</div>
					</a>
		...
		<div id="detail" class="w3-container person">
			...
			<h4>
				<i class="material-icons">contact_mail</i>&nbsp;&nbsp;<span
					id="dsender"></span><br> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;<span
					id="dwriteday"></span>
			</h4>
