...
<style type="text/css">
.input{-webkit-user-modify:read-write }
.circle1 {
		...
		<div class="w3-card-4">
			...
			<div class="w3-container w3-white">
				<div class="circle1">
					...
					<img alt="face" src=<c:url value='/resources/images/face.png'/> height="100%" height="auto">
					</a>
				</div>
				<input type="file" name="FACEFILE_1" style="display:none;" accept="image/*">
