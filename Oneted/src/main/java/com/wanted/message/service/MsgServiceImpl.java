package com.wanted.message.service;
...
import com.wanted.message.dao.MsgDAO;
...
public class MsgServiceImpl implements MsgService {
	...
	@Override
	public void sendMsg(Map<String, Object> map, HttpServletRequest request) throws Exception {
		msgDAO.sendMsg(map);
	}
