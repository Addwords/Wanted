...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/style.css?ver=0.3" />
	...
	<nav class="w3-sidebar w3-collapse w3-white w3-animate-left"
		...
		<div class="w3-container">
			<a href="" onclick="w3_close()"
				...
				src="<c:url value='/common/getImage.do?IMG_NAME=${BOARDLIST[0].TEAM_IMG}'/>"
...
<%@ include file="/WEB-INF/include/include-body.jspf"%>
	...
	<script>
		...
		function fn_search(pageNo) {
			...
			comSubmit.setUrl("<c:url value='/teamDetail/teamBoardList.do' />");
		...
		function fn_insertBoard() {
			...
			comSubmit.setUrl("<c:url value='/teamDetail/insertBoard.do' />");
			comSubmit.addParam("WRITER", email);
			comSubmit.submit();
		}
