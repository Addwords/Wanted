...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
  ...
  <div class="w3-display-middle" style="text-align: center;">
    ...
    <p class="w3-large w3-center"><a id="total" style="color:white; text-decoration:underline; font-size: 30px" href="javascript:fn_memberSearch()">11</a> TEAMS are waiting.</p>
  </div>
  <div class="w3-display-bottomleft w3-padding-large">
    Powered by <a href="http://www.choongang.co.kr/" target="_blank">CENTER_602</a>
  </div>
</div>
